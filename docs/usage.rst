...
The following sections contain some example-functions, which you can use and adapt for your analysis. A sketch of the UFalcon pipeline using the example-scripts is given below:
...
.. literalinclude:: ../UFalcon/scripts/config.yaml
    :language: python
